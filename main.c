...
/*   Updated: 2023/01/15 19:39:35 by ataji            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->textureimg[EA].img = mlx_xpm_file_to_image(data->var.mlx, data->texture[EA], &data->textureimg[EA].width, &data->textureimg[EA].heigth);
